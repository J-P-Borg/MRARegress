...
```{r }
MatrCc	<- MRARegress (MatExp)					# Perturb = NULL, NodeName = NULL, KnlgMap = NULL, Method = "TLR", MapExper = NULL, Verbose = FALSE (default values)
if (! is.null(MatrCc)) {
	r 	<- round(MatrCc, 3)
	DrawGraph (MatrCc)
}
...
MatrCc	<- MRARegress (MatExp2)							# Perturb = NULL, NodeName = NULL, KnlgMap = NULL, Method = "TLR", MapExper = NULL, Verbose = FALSE (default values)
if (! is.null(MatrCc)) {
