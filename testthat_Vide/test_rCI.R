...
Res		<- Regress2 (MatExp)
NomSol	<- "C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Regress2/data/Solution_6K.rda"
RootW	<- "C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Temporaire"


#	PART ONE : check input data

Ret			<- Regress2 (MatExp, Relative=FALSE)

Ret1		<- Ret
Ret1$Input$Variables	<- NULL
cat ("rCI - Incorrect Ret -1\n")
test_that("Incorrect Ret -1", {
  expect_null (rCI (Ret1, F6, St, P0, Perturbs, 2, 10, 0.05))		# Bad return of Regress2
})
...
BadSol	<- "C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Regress2/Solution_6K.rda"
test_that("Bad Solution -1", {
...
cat ("Part Two \n")
RRoot	<-	"C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Regress2/data/"
...
###		nbN			<- 4
###		load ("C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Regress2/data/ResO2_4.rda")		#  This is an 'Order2' solution. We need the corresponding MatrCc matrix
...
###		}
###		
###		save (Res_4, file="C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Regress2/data/Res_4.rda")
NomSol4		<- "C:/Users/jean-pierre.borg/IRCM/These/Recherche/Packages/Regress2/data/Res_4.rda"
...
Res_4_2		<-	Regress2(Exp_$Exp, Exp_$Pert, Method="Order2", Relative=FALSE)
